<#
.SYNOPSIS
    CIS Remediation Script for 17.5.1 - Ensure 'Audit Account Lockout' is set to include 'Failure'
.DESCRIPTION
    This script remediates the configuration of Audit Account Lockout settings using auditpol.exe.
    It configures the subcategory to include failure auditing.
.NOTES
    CIS ID: 17.5.1
    Profile: L1
    File Name: 17.5.1-remediate-account-lockout.ps1
