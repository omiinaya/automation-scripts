# Remediation: Microsoft iSCSI Initiator Service (MSiSCSI) setting on Windows
# CIS Benchmark: 5.11 (L2) Ensure 'Microsoft iSCSI Initiator Service (MSiSCSI)' is set to 'Disabled'
