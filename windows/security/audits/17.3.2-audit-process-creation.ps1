<#
.SYNOPSIS
    CIS Audit Script for 17.3.2 - Ensure 'Audit Process Creation' is set to include 'Success'
.DESCRIPTION
    This script audits the configuration of Audit Process Creation settings using auditpol.exe.
    It checks if the subcategory is properly configured to include success auditing.
.NOTES
    CIS ID: 17.3.2
    Profile: L1
    File Name: 17.3.2-audit-process-creation.ps1
...
$auditScriptBlock = {
    try {
        ...
        return @{
            ...
            Source = "auditpol.exe"
            Details = "Subcategory GUID: {0cce922b-69ae-11d9-bed3-505054503030}"
