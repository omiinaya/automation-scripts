<#
.SYNOPSIS
    CIS Audit Script for 17.2.3 - Ensure 'Audit User Account Management' is set to 'Success and Failure'
.DESCRIPTION
    This script audits the configuration of Audit User Account Management settings using auditpol.exe.
    It checks if the subcategory is properly configured for both success and failure auditing.
.NOTES
    CIS ID: 17.2.3
    Profile: L1
    File Name: 17.2.3-audit-user-account-management.ps1
...
$auditScriptBlock = {
    try {
        ...
        return @{
            ...
            Source = "auditpol.exe"
            Details = "Subcategory GUID: {0cce9235-69ae-11d9-bed3-505054503030}"
