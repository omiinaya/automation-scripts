<#
.SYNOPSIS
    CIS Audit Script for 17.5.5 - Ensure 'Audit Other Logon/Logoff Events' is set to 'Success and Failure'
.DESCRIPTION
    This script audits the configuration of Audit Other Logon/Logoff Events settings using auditpol.exe.
    It checks if the subcategory is properly configured to include both success and failure auditing.
.NOTES
    CIS ID: 17.5.5
    Profile: L1
    File Name: 17.5.5-audit-other-logonlogoff-events.ps1
