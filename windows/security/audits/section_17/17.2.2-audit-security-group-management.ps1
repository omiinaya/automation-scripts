<#
.SYNOPSIS
    CIS Audit Script for 17.2.2 - Ensure 'Audit Security Group Management' is set to include 'Success'
.DESCRIPTION
    This script audits the configuration of Audit Security Group Management settings using auditpol.exe.
    It checks if the subcategory is properly configured to include success auditing.
.NOTES
    CIS ID: 17.2.2
    Profile: L1
    File Name: 17.2.2-audit-security-group-management.ps1
...
$auditScriptBlock = {
    try {
        ...
        return @{
            ...
            Source = "auditpol.exe"
            Details = "Subcategory GUID: {0cce9237-69ae-11d9-bed3-505054503030}"
