...
# Toggle the Tablet Input Service using the ServiceManager module
Invoke-ServiceToggle -ServiceName "TabletInputService" -ServiceDisplayName "Pen Service" -EnableStartupType "Manual"