...
# Manipulates the UserPreferencesMask binary value (bit 0x40)
...
try {
    ...
    # Bit 0x40 (seventh bit in first byte) controls "Fade or slide menus into view"
    ...
    Wait-OnError -ErrorMessage "Failed to toggle fade menus setting: $($_.Exception.Message)"
}
