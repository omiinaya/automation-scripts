<#
.SYNOPSIS
    CIS Remediation Script for 17.5.4 - Ensure 'Audit Logon' is set to 'Success and Failure'
.DESCRIPTION
    This script remediates the configuration of Audit Logon settings using auditpol.exe.
    It configures the subcategory to include both success and failure auditing.
.NOTES
    CIS ID: 17.5.4
    Profile: L1
    File Name: 17.5.4-remediate-logon.ps1
