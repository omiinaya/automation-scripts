<#
.SYNOPSIS
    CIS Remediation Script for 17.1.1 - Ensure 'Audit Credential Validation' is set to 'Success and Failure'
.DESCRIPTION
    This script remediates the configuration of Audit Credential Validation settings using auditpol.exe.
    It configures the subcategory for both success and failure auditing.
.NOTES
    CIS ID: 17.1.1
    Profile: L1
    File Name: 17.1.1-remediate-credential-validation.ps1
