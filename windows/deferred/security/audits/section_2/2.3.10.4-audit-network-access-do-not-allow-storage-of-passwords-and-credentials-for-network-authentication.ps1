<#
.SYNOPSIS
    Audit script for CIS ID 2.3.10.4: Network access: Do not allow storage of passwords and credentials for network authentication

.DESCRIPTION
    This script audits the configuration of 'Network access: Do not allow storage of passwords and credentials for network authentication' 
...
.EXAMPLE
    .\2.3.10.4-audit-network-access-do-not-allow-storage-of-passwords-and-credentials-for-network-authentication.ps1
