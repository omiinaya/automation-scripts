<#
.SYNOPSIS
    CIS Audit Script for 17.2.1 - Ensure 'Audit Application Group Management' is set to 'Success and Failure'
.DESCRIPTION
    This script audits the configuration of Audit Application Group Management settings using auditpol.exe.
    It checks if the subcategory is properly configured for both success and failure auditing.
.NOTES
    CIS ID: 17.2.1
    Profile: L1
    File Name: 17.2.1-audit-application-group-management.ps1
...
$auditScriptBlock = {
    try {
        ...
        return @{
            ...
            Source = "auditpol.exe"
            Details = "Subcategory GUID: {0cce9239-69ae-11d9-bed3-505054503030}"
